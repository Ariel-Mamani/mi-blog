            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 ">
                @guest
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('login') }}" class="text-white hover:text-blue-500 text-lg">Iniciar sesión</a>
                        <a href="{{ route('register') }}" class="text-white hover:text-blue-500 text-lg">Registrarse</a>
                    </div>
                @endguest
                @auth
